...
export const BookingsManager = () => {
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      if (success) {
        toast.success('Rezervácia bola natrvalo odstránená');
      } else {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <DeleteConfirmModal 
        ...
        title="Odstrániť rezerváciu?"
        message="Naozaj chcete túto rezerváciu natrvalo odstrániť? Táto akcia je nevratná."
      />
    </div>
  );
};
